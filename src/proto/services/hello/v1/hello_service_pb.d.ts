...
export class GreetRequest extends jspb.Message { 
    ...
    getLanguageCode(): com_language_v1_language_pb.Language.Code;
    setLanguageCode(value: com_language_v1_language_pb.Language.Code): GreetRequest;
...
export namespace GreetRequest {
    export type AsObject = {
        name: string,
        languageCode: com_language_v1_language_pb.Language.Code,
    }
}
